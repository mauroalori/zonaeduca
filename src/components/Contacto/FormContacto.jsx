...
function FormContacto() {
    return (
        ...
        <div className={`flex flex-col items-center justify-center h-screen  bg-cover`} style={{ backgroundImage: `url(${Fondocole})` }}>
            ...
            <div className={`flex flex-row items-center justify-center `}>
                {/* CAJA  */}
                <div className="flex w-[16rem] md:w-[22rem] lg:w-[30rem] h-[16rem] md:h-[22rem] lg:h-[30rem] justify-center items-center bg-white shadow-lg shadow-gray-300">
                    {/* CONTENEDOR ITEMS  */}
                    <div className="w-[16rem] md:w-[22rem] lg:w-[30rem] m-auto flex  flex-col justify-center items-center md:mb-36 md:gap-6 gap-2">
                        {/* ITEMS  */}
                ...
                <div>
                    <form
                        action=""
                        className="bg-white w-[16rem] md:w-[22rem] lg:w-[30rem] h-[16rem] md:h-[22rem] lg:h-[30rem] flex flex-col justify-center  shadow-lg shadow-gray-300 p-5 overflow-auto"
                    >
